...
function makePanel(panelData, open, close) {
  ...
  */
  ...
  panelContent.appendChild(randomImg)
  ...
  panelButtons.addEventListener('click', () => {
    openButton.classList.contains('hide-btn') ? openButton.classList.remove('hide-btn') : openButton.classList.add('hide-btn')
    !closeButton.classList.contains('hide-btn') ? closeButton.classList.add('hide-btn') : closeButton.classList.remove('hide-btn')
    !panelContent.classList.contains('toggle-on') ? panelContent.classList.add('toggle-on') : panelContent.classList.remove('toggle-on')
  })
...
panelData.map((data) => {
  const panel = makePanel(data, open, close)
